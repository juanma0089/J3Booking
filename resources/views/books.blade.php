...
@section('body')
    <div id="mainPanel" class="container-fluid mt-4">
        ...
        <div id="lista_ac">
            ...
            <section class="py-0 list-group-item list-group-item-action border-bottom">
                <div class="p-0 d-flex justify-content-around row">
            ...
            <section class="py-0 list-group-item list-group-item-action border-bottom">
                <div class="p-0 d-flex justify-content-around row py-1 text-white">
